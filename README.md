...
> ⚠️ **Important:** The API keys currently in the notebook are the team's own keys. Replace them with your own keys before running to avoid hitting rate limits, also the current ones might have been deactivated. This is done by Open AI and Huggingface to prevent unauthorized acces of the apis in public Repositories.
---
